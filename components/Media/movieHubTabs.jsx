...
const ICONS = {
    // Keys must match the tab `id`s below exactly — they are looked up by id.
    movies: icon("M3.75 9.75 12 3m0 0 8.25 6.75M12 3v18m0-18 8.25 6.75M12 12 3.75 18.75M12 12l8.25 6.75"),
    series: icon(
