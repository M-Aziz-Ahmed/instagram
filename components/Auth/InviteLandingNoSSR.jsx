...
const InviteLandingClient = dynamic(() => import("./InviteLandingClient"), {
    ssr: false,
    loading: () => (
...
export default function InviteLandingNoSSR({ inviteCode }) {
    return <InviteLandingClient inviteCode={inviteCode} />;
}
