...
$setup = Get-ChildItem (Join-Path $releaseDir "nsis") -Filter "*x64-setup.exe" | Select-Object -First 1
...
$msi = Get-ChildItem (Join-Path $releaseDir "msi") -Filter "*.msi" | Select-Object -First 1
