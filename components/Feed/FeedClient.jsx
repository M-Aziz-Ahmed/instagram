...
import FloatingDownloadButton from "@/components/FloatingButton/FloatingDownloadButton";
                        ...
                        {isGuest ? (
                            ...
                            <>
                                <button
                                    ...
                                    className="p-2.5 text-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-full transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center"
                                >
