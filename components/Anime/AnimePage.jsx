                    ...
                    <div className="flex flex-col lg:flex-row gap-6">
                        ...
                        <div className="flex-1 min-w-0 space-y-3">
                            ...
                            <div className="flex flex-wrap items-center gap-3 text-sm text-gray-500 dark:text-gray-400">
                                ...
                                {selected.source && selected.source !== "none" && <span className="px-2 py-0.5 bg-orange-100 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400 rounded-full text-[10px] font-medium">AnimeUnity</span>}
                            </div>
