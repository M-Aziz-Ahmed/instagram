...
function LiveStreamModal({ streamId: initialStreamId, hostUsername, onClose }) {
    ...
    return (
        <div ref={modalRootRef} className="fixed inset-0 z-50 bg-black flex flex-col" style={{ height: "100dvh" }}>
            ...
            {isHost && !isFullscreen && (
                <div className="fixed bottom-0 left-0 right-0 flex items-center justify-center gap-3 px-4 pt-3 bg-gradient-to-t from-black via-black/80 to-transparent z-[60] safe-bottom">
