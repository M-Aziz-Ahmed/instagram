...
export default function MusicPanel({ socket, channelId, user, initialState }) {
    ...
    useEffect(() => {
        ...
        if (playing && musicState?.startedAt && ytPlayerRef.current) {
    ...
    return (
        <div className="flex flex-col h-full bg-gray-950 relative">
            ...
            <div className="absolute opacity-0 pointer-events-none" style={{ width: 1, height: 1, overflow: "hidden" }}>
                <div id={`yt-player-${channelId}`} ref={containerRef} />
            </div>
            ...
            {current && (
                <div className="px-3 py-3 border-b border-white/10 shrink-0">
                    <div className="flex items-center gap-2 mb-2">
                        <p className="text-[10px] text-gray-500 uppercase tracking-wider">Now Playing</p>
                        {playing && (
